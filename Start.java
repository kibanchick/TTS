...
public class Start {
    public static void main(String[] args) {
        ...
        players.add(new Player("Artem Malyshev", 0, false));
        players.add(new Player("Artem Petrov", 0, false));
        players.add(new Player("Ivan Stepanov", 0, false));
        players.add(new Player("Yan", 0, false));
        players.add(new Player("Niko", 0, false));
        players.add(new Player("Arto", 0, false));
        players.add(new Player("Dimitri Molokanov", 0, false));
        players.add(new Player("Dimitri", 0, false));
        players.add(new Player("Vasiliy", 0, false));
        players.add(new Player("Timofey", 0, false));
